...
abstract class WebPage extends Generic
{
    ...
    private $documentHTML;          // escopo global do documento
    ...
    public function toString() 
    {
        ...
        $this->documentHTML = "<!doctype html>\n";
        $this->documentHTML .= "<html lang=\"".$this->getLang()."\">\n";
        $this->documentHTML .= $this->getHead();
        $this->documentHTML .= $this->getBody() . "\n";
